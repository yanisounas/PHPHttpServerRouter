...
namespace PHPHttpServerRouter\Router;

use PHPHttpServerRouter\Router\Exceptions\MethodNotSupported;
use PHPHttpServerRouter\Router\Exceptions\RouteNameAlreadyDeclared;
use PHPHttpServerRouter\Router\Exceptions\RouteNotFound;
...
class RouterInitializer
{
    ...
    {
        $controllers = [];
        $namespace = ($prefix) ? "PHPHttpServerRouter\\Controller\\$prefix\\" : "PHPHttpServerRouter\\Controller\\";
